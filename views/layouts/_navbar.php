        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5"> <a href="<?= Yii::$app->homeUrl ?>" class="navbar-brand">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav ml-auto py-0">
                    ...
                    <a href="<?= Yii::getAlias('@web/site/service') ?>" class="nav-item nav-link <?= $action == 'service' ? 'active' : '' ?>">Purposes</a>
                    ...
                    <div class="nav-item dropdown"> <a href="#" class="nav-link dropdown-toggle <?= $action == 'bloggrid' ? 'active' : '' ?>" data-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu border-0 rounded-0 m-0"> <a href="<?= Yii::getAlias('@web/site/bloggrid') ?>" class="dropdown-item <?= $action == 'bloggrid' ? 'active' : '' ?>">Blog Grid</a>
                    ...
                    </div> <a href="<?= Yii::getAlias('@web/site/contact') ?>" class="nav-item nav-link <?= $action == 'contact' ? 'active' : '' ?>">Contact</a>
                    <a href="<?= Yii::getAlias('@web/site/contact') ?>" class="nav-item nav-link"> <i class="fas fa-shopping-cart"></i> <span class="badge badge-danger navbar-badge">3</span> </a>
                </div>
            </div>
        </nav>
    </div>
